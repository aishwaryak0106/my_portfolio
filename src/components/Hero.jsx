...
const Hero = () => {
  return (
    ...
    >
        <div className='container mx-auto px-6 flex flex-col md:flex-row tems-center justify-between'>
            {/*left side content*/}
            <div className='md:w-1/2 mb-10 md:mb-0'>
                <h1 className='text-4xl md:text-6xl font-bold mb-4'>
                    Hi, I'm <span className='text-purple'>Aishwarya Kavil</span>
                </h1>
            ...
            <div className='md:w-1/2 flex justify-center'>
                <div className='relative w-64 h-64 md:w-80 md:h-80'>
                    <div className='basolute inset-0 rounded-full bg-gradient-to-r from-purple to-pink opacity-70'>
                        ...
                        className='reltive rounded-full w-64 h-64 md:w-80 md:h-80 object-cover z-10'
